...
class _Auth2CreateWidgetState extends State<Auth2CreateWidget>
  ...
  void initState() {
    ...
    _model.emailAddressTextController ??=
        TextEditingController(text: 'todd.c.herron@gmail.com');
    _model.emailAddressFocusNode ??= FocusNode();

    _model.passwordTextController ??= TextEditingController(text: 'test1234');
                                ...
                                onPressed: () async {
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: const Text('BREAKPOINT - 1'),
                                        content: const Text(
                                            'Auth Create Account completed'),
                                        actions: [
                                          TextButton(
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: const Text('BREAKPOINT - 2'),
                                        content:
                                            const Text('Auth Send Email completed'),
                                        actions: [
                                          TextButton(
                                            onPressed: () => Navigator.pop(
                                                alertDialogContext),
